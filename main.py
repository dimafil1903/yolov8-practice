...
async def load_model():
    ...
    # Load the yolo model
    model_sample_model = YOLO("./models/sample_model/best-v8.pt", task='detect')

    model_sample_model.cuda(0)

    model_sample_model.predict('tests/test_image.jpg')
...
def img_object_detection_to_json(request: Request, file: bytes = File(...)):
    """
    ...
    predict = detect_sample_model(input_image, model_sample_model)
